WITH
social_campaign_performance AS (
    ...
    SELECT
        ...
        COALESCE(
            SUM(f_creative.num_creative_impression),
            0
        ...
        COALESCE(
            SUM(f_creative.creative_cost_usd),
            0
        ) AS total_cost,

        COALESCE(
            SUM(f_creative.num_creative_click),
            0
        ) AS total_clicks,
